...
--
-- Database: `creativeitem_ekattor_install`
--
...
INSERT INTO `attendance_backup` (`attendance_id`, `status`, `student_id`, `date`, `year`, `class_id`, `section_id`, `session`) VALUES
(1, 0, 4, '2016-03-08', '2016-2017', 1, 1, ''),
(2, 0, 5, '2016-03-08', '2016-2017', 1, 1, '');
...
--
ALTER TABLE `language`
  MODIFY `phrase_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=348;
--
