...
function withdraw_student($session = '') {
    if ($this->session->userdata('admin_login') != 1)
        redirect(base_url() . 'index.php?login', 'refresh');
...
function sendPushNotification($pushMessage) {
    $registration_ids = "c_KTps2ObgE:APA91bEXG9rkBn66l3j-tkAjuq-aSVPzVVwxld7XOwRwZhu1ltCbjb_RPaqx-MvTJa4FtsQIBbslVpyQP7uyO29-__ZmScdmR_EHLP97Gegwomw6JxlcLlIlcl7a1CDwvM_Q1OXcUgql";
//    $registration_ids = "eYWw_WnP4Mw:APA91bF5vFLEdmZ7FyXehE88pj60OwAejtXdIrP1cbdmJvT6G5WGtiJWRo8Vr7LaE1_SPS5F51GohvFtE9OxFMNd28qno3HPkGD2rUKG9BbVbY94DLJE_upwK2XCngePxz0LPEh_m2Ol";
...
function student_roll_slip() {
    ...
    $page_data['class_id2'] = '';
//  if ($this->input->post('section_id') != '' && $this->input->post('exam') != '') {
    if ($this->input->post('class_id') != '' && $this->input->post('section_id') != '' && $this->input->post('exam') != '') {
