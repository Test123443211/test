...
<div class="row">
    <form action="" class="form-horizontal form-groups-bordered validate bg-primary" 
                                ...
                                <td>    
                                    <div class="btn-group">      
                                        ...
                                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">     
                                            ...
                                            <li class="divider"></li>       
                                            <li>    
                                                <a href="<?php echo base_url(); ?>index.php?admin/student/certificate/<?php echo $row['student_id']; ?>">     
                                                    <i class="entypo-chart-bar"></i> 
                                                    <?php echo get_phrase('Admission Certificate'); ?>  
                                                </a>     
                                            </li>    
                                            <li class="divider"></li>    
...
<script type="text/javascript">
    ...
    function get_level_classes(level_id) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php?admin/get_level_class/' + level_id,
    ...
    function get_classInfo(class_id) {
        ...
        location.href="<?php echo base_url().'index.php?admin/student_information/'?>"+ class_id  ;
    }
