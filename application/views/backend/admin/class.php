                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Education Level');?></label>
                                <div class="col-sm-5">
                                    <select name="education_level" class="form-control select2" style="width:100%;">
                                        <option value=""><?php echo get_phrase('select_level');?></option>
                                    	<?php 
										$levels = $this->db->get('education_level')->result_array();
